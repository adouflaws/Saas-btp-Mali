...
export default function UpdatePasswordPage() {
  ...
  // createBrowserClient le détecte automatiquement au montage
  useEffect(() => {
        ...
        <div className="bg-[#242424] rounded-2xl border border-white/[0.07] shadow-2xl p-8">
          {success ? (
            <div className="text-center py-4">
              ...
              <p className="text-gray-500 text-[13px]">Redirection vers le tableau de bord…</p>
            </div>
          ) : !ready ? (
            ...
            <>
              <div className="mb-6">
                ...
                <p className="text-gray-600 text-[12px] mt-1">Choisissez un mot de passe sécurisé d&apos;au moins 6 caractères.</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    minLength={6}
                    className={`w-full bg-[#1C1C1C] border rounded-xl px-4 py-3 text-sm focus:outline-none focus:ring-2 transition-all text-white placeholder-gray-700 ${
                      confirm && confirm !== password
                        ? 'border-red-500/50 focus:border-red-500 focus:ring-red-500/15'
                        : 'border-white/[0.08] focus:border-orange-500 focus:ring-orange-500/15'
                    }`}
                  />
                  {confirm && confirm !== password && (
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-600 hover:to-orange-700 active:scale-[0.98] text-white font-semibold py-3 rounded-xl transition-all shadow-lg shadow-orange-500/25 disabled:opacity-60 disabled:cursor-not-allowed mt-2"
                >
                  {loading ? (
